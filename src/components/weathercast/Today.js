      ...
      {display === true &&
        ...
        >
          <div className='location'>
            ...
            <p>{currentDayName(weatherData.current?.dt)}, {currentMonth(weatherData.current?.dt)} {currentDay(weatherData.current?.dt, weatherData.timezone_offset)}, {currentHour(weatherData.current.dt, weatherData.timezone_offset)}:{currentMinutes(weatherData.current.dt)}
            </p>
          </div>
